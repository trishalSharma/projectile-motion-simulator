import { calculateMaxHeight, calculateRange,  calculateTof } from "../utils/calculation";
...
export default function Stats({ velocity, angle, gravity }) {
  ...
  const tof = calculateTof(velocity, angle, gravity).toFixed(2); 

  return (
    <div className=" text-yellow-500 space-y-2">
      <p>Max Height: {maxHeight} m</p>
      <p>Range: {range} m</p>
      <p>Time of Flight: {tof} s</p>
    </div>
  );
}
